...
public class EmployeeQueryController {
  ...
  @Operation(
      ...
      description = "Get All Employees with IS DISCIPLINE filter")
        ...
        queryGateway
            .query(
                new GetAllEmployeesQuery(
                    criteria.getIsDiscipline() != null && criteria.getIsDiscipline()),
                ResponseTypes.multipleInstancesOf(EmployeeDTO.class))
            .join();
  ...
  public ResponseEntity<EmployeeDTO> getEmployee(@PathVariable("employeeId") String employeeId) {
    EmployeeDTO employee =
        queryGateway
            .query(
                new GetDetailEmployeeQuery(employeeId), ResponseTypes.instanceOf(EmployeeDTO.class))
            .join();
