                ...
                <table cellpadding="0" cellspacing="0" align="center" class="es-header" role="none"
                    ...
                    <tr>
                        <td align="center" style="padding:0;Margin:0">
                            <table align="center" cellpadding="0" cellspacing="0" class="es-header-body"
                                   style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:transparent;width:600px"
                                   role="none">
                                <tr>
                                    <td align="left" bgcolor="#4c8aa7"
                                                        ...
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0;font-size:0px">
                                                                <a target="_blank" href="https://viewstripo.email"
                                                                   style="mso-line-height-rule:exactly;text-decoration:underline;color:#3D7781;font-size:14px"><img
                                                                            src="https://fvexhne.stripocdn.email/content/guids/CABINET_2e7b5e7c419fb67c255cca2bf344a8df/images/32821618490858574.png"
                                                                            alt="Logo" width="120" title="Logo"
                    ...
                    <tr>
                        <td align="center" style="padding:0;Margin:0">
                            <table cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center"
                                   ...
                                   style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#ffffff;border-right:1px solid #4c8aa7;border-left:1px solid #4c8aa7;width:600px"
                                   role="none">
                                <tr>
                                            ...
                                            <tr>
                                                <td align="left" style="padding:0;Margin:0;width:558px">
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                style="padding:0;Margin:0;padding-top:30px;padding-bottom:20px">
                                                                <h1 class="es-m-txt-c"
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                ...
                                                                <a target="_blank" href="https://viewstripo.email"
                                                                   style="mso-line-height-rule:exactly;text-decoration:underline;color:#3D7781;font-size:14px"><img
                                                                            src="https://fvexhne.stripocdn.email/content/guids/CABINET_a258b781aab0bd98d6f802cac9b1796c/images/group_128.png"
                                                                            alt="" width="370" class="adapt-img"
                                                                            style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                            height="293"></a></td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <tr>
                                                <td valign="top" align="center" class="es-m-p0r"
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                style="Margin:0;padding-bottom:20px;padding-top:10px;padding-right:40px;padding-left:40px">
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#666666;font-size:14px">
                                                                    Hello, ${name}! Neque gravida in fermentum et
                                                                    sollicitudin ac. Felis eget velit aliquet sagittis
                                                                    id consectetur purus ut. Aliquet nec ullamcorper sit
                                                                    amet risus nullam eget felis eget. Gravida cum
                                                        ...
                                                        <tr>
                                                            <td align="center" class="es-m-txt-c"
                                                                ...
                                                                <table border="0" width="35%" height="100%"
                                                                       ...
                                                                       style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;display:inline-table;width:35% !important"
                                                                       role="presentation">
                                                                    <tr>
                                                                        <td style="padding:0;Margin:0;border-bottom:1px solid #fb8500;background:none;height:0px;width:100%;margin:0px"></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center"
                                                                ...
                                                                <p class="es-m-txt-c"
                                                                   style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:40px;letter-spacing:0;color:#666666;font-size:20px">
                                                                    Date: <strong>26 August&nbsp;at 1:00 PM</strong><br>Duration:
                                                                    <strong>90 min</strong></p></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                ...
                                <tr>
                                    <td align="left"
                                        style="Margin:0;padding-top:10px;padding-right:40px;padding-left:40px;padding-bottom:40px">
                                        <table cellpadding="0" cellspacing="0" width="100%" role="none"
                                               style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                            <tr>
                                                        ...
                                                        <tr>
                                                            <td align="center" class="es-m-txt-c"
                                                                style="padding:0;Margin:0"><span
                                                                        class="es-button-border-1636375556347 es-button-border"
                                                                        style="border-style:solid;border-color:#2CB543;background:#fb8500;border-width:0px;display:inline-block;border-radius:30px;width:auto"><a
                                                                            ...
                                                                            target="_blank"
                                                                            class="es-button es-button-1636375556347"
                                                                            style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#FFFFFF;font-size:18px;padding:10px 25px 10px 15px;display:inline-block;background:#FB8500;border-radius:30px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:21.6px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #FB8500"><img
                                                                                src="https://fvexhne.stripocdn.email/content/guids/CABINET_2e7b5e7c419fb67c255cca2bf344a8df/images/41781618489806584.png"
                                                                                alt="icon" width="26" align="absmiddle"
                                                                                style="display:inline-block;font-size:14px;border:0;outline:none;text-decoration:none;vertical-align:middle;margin-right:10px"
                                                                                height="32"><!--<![endif]-->Join Webinar </a>
 </span></td>
                                                        </tr>
                                                    </table>
                                                </td>
                    ...
                    <tr>
                        <td align="center" style="padding:0;Margin:0">
                            <table align="center" cellpadding="0" cellspacing="0" class="es-footer-body"
                                ...
                                <tr>
                                    <td align="left" bgcolor="#4c8aa7"
                                        style="Margin:0;padding-right:20px;padding-left:20px;padding-top:25px;padding-bottom:25px;border-radius:0px 0px 10px 10px;background-color:#4c8aa7">
                                        <table cellpadding="0" cellspacing="0" width="100%" role="none"
                                               style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                            <tr>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" valign="top"
                                                                            ...
                                                                            <a target="_blank"
                                                                               href="https://viewstripo.email"
                                                                               style="mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:14px"><img
                                                                                        title="Facebook"
                                                                                        src="https://fvexhne.stripocdn.email/content/assets/img/social-icons/circle-white/facebook-circle-white.png"
                                                                        ...
                                                                        <td align="center" valign="top"
                                                                            ...
                                                                            <a target="_blank"
                                                                               ...
                                                                               style="mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:14px"><img
                                                                                        title="X"
                                                                                        src="https://fvexhne.stripocdn.email/content/assets/img/social-icons/circle-white/x-circle-white.png"
                                                                        ...
                                                                        <td align="center" valign="top"
                                                                            ...
                                                                            <a target="_blank"
                                                                               ...
                                                                               style="mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:14px"><img
                                                                                        title="Instagram"
                                                                                        src="https://fvexhne.stripocdn.email/content/assets/img/social-icons/circle-white/instagram-circle-white.png"
                                                                                        alt="Inst" width="32"
                                                                                        height="32"
                                                                                        style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"></a>
                                                                        </td>
                                                                        <td align="center" valign="top"
                                                                            style="padding:0;Margin:0"><a
                                                                                    ...
                                                                                    style="mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:14px"><img
                                                                                        title="Youtube"
                                                                                        src="https://fvexhne.stripocdn.email/content/assets/img/social-icons/circle-white/youtube-circle-white.png"
                                                        ...
                                                        <tr>
                                                            <td align="center" class="es-infoblock"
                                                                style="padding:0;Margin:0"><p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;color:#999999;font-size:12px">
                                                                    We have sent you this email because you provided us
                                                                    with your email address as part of the purchasing
                                                                    process on <a target="_blank"
                                                                                  href="https://viewstripo.email"
                                                                                  style="mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:12px">reliability.com</a>&nbsp;Your
                                                                    email address will not be used for any other
                                                                    purpose, unless you have previously opted in to
                                                                    receive emails from us.<br><br>Reliability&nbsp;Inc.,
                                                                    5675 Silver Wharf, Chicago Creek, Connecticut,
                                                                    06331-6807, US</p>
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;color:#999999;font-size:12px">
                                                                    <br><br>To ensure Reliability&nbsp;emails reach your
                                                                    inbox, please add&nbsp;<a target="_blank" href=""
                                                                                              style="mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:12px">email@reliability</a>
                                                            ...
                                                            <td align="center" class="es-infoblock made_with"
                                                                style="padding:0;Margin:0;font-size:0"><a
                                                                        ...
                                                                        style="mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:12px"><img
                                                                            src="https://fvexhne.stripocdn.email/content/guids/CABINET_09023af45624943febfa123c229a060b/images/7911561025989373.png"
                                                                            alt="" width="125"
                                                                            style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                            height="56"></a></td>
                                                        </tr>
